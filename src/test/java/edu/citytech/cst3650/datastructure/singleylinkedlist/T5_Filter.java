...
@DisplayName("Filter By: Nijjar, Jatinder")
public class T5_Filter extends _MainTest {

    @Test
    @DisplayName("see all heros")
    public void t2(){
        var sl = new SingleyLinkedList<>(Hero[]::new);
        var sl2 = new SingleyLinkedList<>(Hero[]::new);
        sl.add(heroes);
