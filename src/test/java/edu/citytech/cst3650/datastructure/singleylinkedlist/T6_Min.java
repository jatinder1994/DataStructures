...
@DisplayName("Min By: Nijjar, Jatinder")
public class T6_Min extends _MainTest {
    ...
    public void t7(){
        var sl = new Stack<>(Integer[]::new);
        sl.push(1_000,1_000_000,100,100_001);
